...
/**
 * 
 * @ClassName: CcUserClassBaseDto
 * @Description: CC_USERCLASS
 * @author Zou_ZhuoQi
 * @date 2013-12-20 下午1:34:10
 * 
 */
@Alias("ccUserClassBaseDto")
public class CcUserClassBaseDto extends CcUserClassBaseDtoKey implements
		Serializable {
