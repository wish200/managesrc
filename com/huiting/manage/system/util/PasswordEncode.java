 ...
 * @Description: 类说明：密码的加密与解密
 * @author Zou_ZhuoQi
 * @date 2013-12-25 上午9:57:30
 */
public class PasswordEncode {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        String passwordMd5 = PasswordEncode.digestPassword("1q2w3e4r");
        System.out.println(passwordMd5);
        System.out.println(PasswordEncode.digestPassword("z中文"));
        System.out.println(PasswordEncode.digestString("123456",
                PasswordEncode.MD5));
        PasswordEncode.digestFile("D:\\PasswordEncode.java",
                PasswordEncode.SHA_512);
